...
class CoAP(object):
    ...
    def receive_request(self, transaction):
        ...
        with transaction:
            ...
            #print "transaction.request.observe : "+str(transaction.request.observe)
            ...
            self._messageLayer.send_response(transaction)
            print "transaction.response : "+str(transaction.response)
    ...
    def notify(self, resource):
        ...
        for transaction in observers:
            ...
            if not(key_token in self._blockLayer.get_receive()):
